...
CREATE TABLE ROOM (
    ...
    START_TIME TIME,
    END_TIME TIME,
    ID_RESERVING_TEACHER INT,
    ID_OCCUPANT_COURSE INT,
    PRIMARY KEY(ID_ROOM),
...
--TODOS LOS DATOS QUE SE MUESTRAN A CONTINUACIÓN SON DE PRUEBA Y NO CORRESPONDEN A LA INFORMACIÓN SENSIBLE DE NINGUNO DE LOS PARTICIPANTES
...
INSERT INTO STUDENT(RUT_STUDENT, NAME_STUDENT, LAST_NAME_STUDENT, ID_COURSE_FK) VALUES
    ("26269131-4", "BRAYAN", "PERAFAN", 1),
    ("12345678-K", "BENJO", "TOREZ", 1),
    ("12345678-K", "ROSANGEL", "GUILLEN", 1),
    ("12345678-K", "KAT", "ZAZA", 2),
    ("12345678-K", "MILO", "PUERTO", 4),
    ("12345678-K", "CARLO", "TONEJON", 5);
...
INSERT INTO USER(USER_EMAIL, USER_PASSWORD, ID_STUDENT_FK, ID_TEACHER_FK) VALUES 
    ...
    ("BRAYAN@INSUCODOS.CL", "INSUCO2", 1, NULL),
    ("BENJO@INSUCODOS.CL", "INSUCO2", 2, NULL),
    ("ROSANGEL@INSUCODOS.CL", "INSUCO2", 3, NULL),
    ("KAT@INSUCODOS.CL", "INSUCO2", 4, NULL),
    ("MILO@INSUCODOS.CL", "INSUCO2", 5, NULL),
    ("CARLO@INSUCODOS.CL", "INSUCO2", 6, NULL);

INSERT INTO ROOM(NAME_ROOM, START_TIME, END_TIME, ID_RESERVING_TEACHER, ID_OCCUPANT_COURSE) VALUES
    ('Laboratorio A', NULL, NULL, NULL, NULL),
    ('Laboratorio B', NULL, NULL, NULL, NULL),
    ('Laboratorio C', NULL, NULL, NULL, NULL),
    ('Laboratorio D', NULL, NULL, NULL, NULL);
